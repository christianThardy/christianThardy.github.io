...
In any case, a future where computers achieve a human-level of understanding of the fundamental principles and properties that make up language and cognition will likely be realized through an imperfect pragmatic, rather than an imperfect theoretical perspective of how the world works.

...
- **Finding:** All models exhibit ~50% negative-eigenvalue ratios in OV matrices.
  - Sparse sets of heads (~16%) maintain counterfactual narrative states; ~3% actively suppress world knowledge.
  - Suppression is far stronger in reasoning contexts (93-96%) than factual ones (~65%).

...
These observations of suppression patterns across reasoning tasks suggests a hypothesis that these mechanisms play an important role in allowing specific types of capabilities. My next steps are to establish causality beyond correlation, so I'll need comphrehensive interventional studies. After that I can see interesting aignment relevant investigations coming from this work in the form of mechanism steering, novel loss functions, model behavioral detection or advanced low-rank updates to mechanisms.

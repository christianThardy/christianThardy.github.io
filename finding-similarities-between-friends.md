...
Section 4 detailed the mathematical and lay intuitions on how to use the t-SNE algorithm to visualize word embeddings derived from one-dimensional vectors from word2vec that were transformed to tensors to build semantic intuitions of the dataset....
